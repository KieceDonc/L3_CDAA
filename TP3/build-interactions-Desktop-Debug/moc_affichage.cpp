...
#include "../interactions0/affichage.h"
...
QT_MOC_LITERAL(1, 10, 9), // "LCDupdate"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 10), // "textAppend"
QT_MOC_LITERAL(4, 32, 8) // "recvData"

    },
    "Affichage\0LCDupdate\0\0textAppend\0"
    "recvData"
};
...
void Affichage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->LCDupdate((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->textAppend((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Affichage::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Affichage::LCDupdate)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Affichage::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Affichage::textAppend)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Affichage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Affichage.data,
...
// SIGNAL 0
void Affichage::LCDupdate(int _t1)
{
...
// SIGNAL 1
void Affichage::textAppend(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
